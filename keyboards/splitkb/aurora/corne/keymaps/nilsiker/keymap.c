...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYOUT_LAYER_HUB] = LAYOUT_split_3x6_3(
        QK_BOOT, DF(0), DF(1), DF(2), DF(3), TG(4),                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
    ...
    [LAYOUT_RPG] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G,                 KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
        KC_LSFT, LALT_T(KC_Z), KC_X, KC_C, KC_V, KC_B,      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TG(4), 
                                  KC_LGUI, MO(5), KC_SPC,      KC_ENT, _______, _______),

     [LAYOUT_RPG_LOWER] = LAYOUT_split_3x6_3(
        KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5,          KC_6, KC_7, KC_8, KC_9, KC_0, _______, 
        KC_6, KC_A, KC_S, KC_D, KC_J, KC_K,          KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
        MO(6), _______, KC_X, KC_C, KC_V, KC_M,          KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TG(4), 
                    KC_LGUI, _______, KC_BSPC,          KC_ENT, _______, _______),
    
    [LAYOUT_RPG_RAISE] = LAYOUT_split_3x6_3(
        _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,         KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, _______, 
        KC_F6, KC_A, KC_S, KC_D, KC_J, KC_K,              KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_M,              KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TG(4), 
                    KC_LGUI, _______, KC_BSPC,              KC_ENT, _______, _______)
};
